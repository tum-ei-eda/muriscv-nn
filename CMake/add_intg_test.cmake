...
macro(add_muriscv_nn_intg_test TEST_NAME)
  ...
  # TODO(fabianpedd): Reintroduce test timeout if(${SIMULATOR} STREQUAL "ETISS") # TODO(fabianpedd): make ETISS tests
  # fail after 2 second for now set_tests_properties(${TEST_NAME} PROPERTIES TIMEOUT 2) else() # Tests should not take
  # longer than 15 seconds set_tests_properties(${TEST_NAME} PROPERTIES TIMEOUT 15) endif()
