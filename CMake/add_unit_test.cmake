...
macro(add_muriscv_nn_unit_test TEST_NAME)
  ...
  if(${SIMULATOR} STREQUAL "ETISS")
    add_executable_pulpino(${TEST_NAME} ${PROJECT_SOURCE_DIR}/Tests/TestCases/${TEST_FILE_NAME}/${TEST_FILE_NAME}.c)
  else()
    add_executable(${TEST_NAME} ${PROJECT_SOURCE_DIR}/Tests/TestCases/${TEST_FILE_NAME}/${TEST_FILE_NAME}.c)
  endif()
