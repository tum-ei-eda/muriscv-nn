...
# Contains toolchain configurations and settings for using compiler for K230 real HW with linux
...
set(RISCV_GCC_BASENAME "riscv64-unknown-linux-gnu" CACHE STRING "Base name of the toolchain executables.")
...
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -march=${RISCV_ARCH} -mabi=${RISCV_ABI} -mcmodel=${RISCV_CMODEL} --static")

# Configure integration tests for benchmarks on hardare
add_definitions(-DHW_BENCHMARK)