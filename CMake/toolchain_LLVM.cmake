...
set(RISCV_LLVM_PREFIX
    "/opt/llvm/bin"
    CACHE PATH "Install location of LLVM RISC-V toolchain."
)
...
set(CMAKE_CXX_FLAGS
    "${CMAKE_CXX_FLAGS} --target=riscv32 -march=${RISCV_ARCH} -mabi=${RISCV_ABI} -mcmodel=${RISCV_CMODEL}"
)
set(CMAKE_CXX_FLAGS
...
set(CMAKE_ASM_FLAGS
    "${CMAKE_ASM_FLAGS} --target=riscv32 -march=${RISCV_ARCH} -mabi=${RISCV_ABI} -mcmodel=${RISCV_CMODEL}"
)
set(CMAKE_ASM_FLAGS
...
set(CMAKE_EXE_LINKER_FLAGS
    "${CMAKE_EXE_LINKER_FLAGS} -march=${RISCV_ARCH} -mabi=${RISCV_ABI} -fuse-ld=lld -mcmodel=${RISCV_CMODEL}"
)
