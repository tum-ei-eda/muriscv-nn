...
export TC_DIR TC_DIR_RV32GC TC_DIR_RV32GCV TC_DIR_RV32GCP TC_DIR_RV32IMV
...
export SIM_DIR SIM_BIN_DIR_OVP SIM_BIN_DIR_SPIKE SIM_BIN_PATH_OVP SIM_BIN_PATH_SPIKE
