...
VL_INLINE_OPT void Vara_tb_verilator___024unit____Vdpiimwrap_debug_tick_TOP____024unit(CData/*0:0*/ &debug_req_valid, CData/*0:0*/ debug_req_ready, IData/*31:0*/ &debug_req_bits_addr, IData/*31:0*/ &debug_req_bits_op, IData/*31:0*/ &debug_req_bits_data, CData/*0:0*/ debug_resp_valid, CData/*0:0*/ &debug_resp_ready, IData/*31:0*/ debug_resp_bits_resp, IData/*31:0*/ debug_resp_bits_data, IData/*31:0*/ &debug_tick__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vara_tb_verilator___024unit____Vdpiimwrap_debug_tick_TOP____024unit\n"); );
    // Body
...
VL_INLINE_OPT void Vara_tb_verilator___024unit____Vdpiimwrap_jtag_tick_TOP____024unit(CData/*0:0*/ &jtag_TCK, CData/*0:0*/ &jtag_TMS, CData/*0:0*/ &jtag_TDI, CData/*0:0*/ &jtag_TRSTn, CData/*0:0*/ jtag_TDO, IData/*31:0*/ &jtag_tick__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vara_tb_verilator___024unit____Vdpiimwrap_jtag_tick_TOP____024unit\n"); );
    // Body
...
VL_INLINE_OPT void Vara_tb_verilator___024unit____Vdpiimwrap_read_elf_TOP____024unit(std::string filename) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vara_tb_verilator___024unit____Vdpiimwrap_read_elf_TOP____024unit\n"); );
    // Body
...
VL_INLINE_OPT void Vara_tb_verilator___024unit____Vdpiimwrap_get_section_TOP____024unit(QData/*63:0*/ &address, QData/*63:0*/ &len, CData/*7:0*/ &get_section__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vara_tb_verilator___024unit____Vdpiimwrap_get_section_TOP____024unit\n"); );
    // Body
