                                                ...
                                                const int32_t block_size)
{
    ...
    int32_t offset_1_packed = ((input_1_offset & 0x000FFL) << 24U) | ((input_1_offset & 0x000FFL) << 16U) |
        ((input_1_offset & 0x000FFL) << 8U) | (input_1_offset & 0x000FFL);
    int32_t offset_2_packed = ((input_2_offset & 0x000FFL) << 24U) | ((input_2_offset & 0x000FFL) << 16U) |
        ((input_2_offset & 0x000FFL) << 8U) | (input_2_offset & 0x000FFL);

    int32_t out_offset_packed = ((out_offset & 0x000FFL) << 24U) | ((out_offset & 0x000FFL) << 16U) |
        ((out_offset & 0x000FFL) << 8U) | (out_offset & 0x000FFL);

    int32_t out_activation_max_packed = ((out_activation_max & 0x000FFL) << 24U) |
        ((out_activation_max & 0x000FFL) << 16U) | ((out_activation_max & 0x000FFL) << 8U) |
        (out_activation_max & 0x000FFL);
    int32_t out_activation_min_packed = ((out_activation_min & 0x000FFL) << 24U) |
        ((out_activation_min & 0x000FFL) << 16U) | ((out_activation_min & 0x000FFL) << 8U) |
        (out_activation_min & 0x000FFL);
