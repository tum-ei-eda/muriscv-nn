                                                ...
                                                const int32_t block_size)
{
    ...
    while (loop_count > 0)
    {
        ...
        input_packed = __rv__add8(input_packed, offset_1_packed);
        int32_t a1 = __rv__zunpkd810(input_packed);
        int32_t b1 = __rv__zunpkd832(input_packed);


        /* Load vec 2 */
        input_packed = muriscv_nn_read_q7x4_ia_fast(&input_2_vect);
        input_packed = __rv__add8(input_packed, offset_2_packed);
        int32_t a2 = __rv__zunpkd810(input_packed);
        int32_t b2 = __rv__zunpkd832(input_packed);
