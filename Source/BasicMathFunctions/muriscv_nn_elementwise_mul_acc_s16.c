 ...
 * Title:        muriscv_nn_elementwise_mul_acc_s16
...
//    #endif
        mul_res = muriscv_nn_requantize(mul_res, out_mult, out_shift);
        mul_res += output[0];
...
//    #endif
        ...
        muriscv_nn_write_q15x2_ia(&output, PACK_Q15x2_32x1(mul_1, mul_2));
