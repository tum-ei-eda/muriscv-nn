                                   ...
                                   const muriscv_nn_dims *output_dims)
{
    ...
    if (muriscv_nn_check_broadcast_required(input_1_dims, input_2_dims))
    {
        if (flat_size_1 == 1)
        {
            ...
            muriscv_nn_max_scalar_s8(input_1_data, input_2_data, output_data, flat_size_2);
        }
        else if (flat_size_2 == 1)
        {
            // muriscv_nn_max_scalar expects the tensor with the scalar value to be provided first
            muriscv_nn_max_scalar_s8(input_2_data, input_1_data, output_data, flat_size_1);
        }
        else
        {
            ...
            for (int32_t i_out_batch = 0; i_out_batch < output_batch; i_out_batch++)
            {
                ...
                {
                    muriscv_nn_max_no_broadcast_s8(input_1_ptr, input_2_ptr, output_data, flat_size_1);
                    output_data += flat_size_1;
                }
                else if (flat_size_1 == 1)
                {
                    // muriscv_nn_max_scalar expects the tensor with the scalar value to be provided first
                    muriscv_nn_max_scalar_s8(input_1_ptr, input_2_ptr, output_data, flat_size_2);
                    output_data += flat_size_2;
                }
                else if (flat_size_2 == 1)
                {
                    // muriscv_nn_max_scalar expects the tensor with the scalar value to be provided first
                    muriscv_nn_max_scalar_s8(input_2_ptr, input_1_ptr, output_data, flat_size_1);
                    output_data += flat_size_1;
                }
                else
                {
    ...
    {
        muriscv_nn_max_no_broadcast_s8(input_1_data, input_2_data, output_data, flat_size_1);
    }
