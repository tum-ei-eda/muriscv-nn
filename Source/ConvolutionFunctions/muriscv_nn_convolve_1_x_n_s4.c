 ...
 * Title:        muriscv_nn_convolve_1_x_n_s4.c
                                               ...
                                               int8_t *output_data)
{
    ...
    int32_t buffer_size =
        muriscv_nn_convolve_1_x_n_s4_get_buffer_size(conv_params, input_dims, filter_dims, output_dims);
    ...
    //     {
    //         return MURISCV_NN_FAILURE;
    //     }
    //
    //     const int32_t right_pad_num = pad_x + asym_pad != 0 ? MAX(1, (pad_x + asym_pad + stride_x - 1) / stride_x) :
    //     0; const int32_t left_pad_num = pad_x != 0 ? MAX(1, (pad_x + stride_x - 1) / stride_x) : 0; const int32_t
    ...
    //             status = muriscv_nn_mat_mul_core_1x_s4(actual_kernel_len * input_ch,
    ...
    //         lhs_rows = no_pad_num;
    //         muriscv_nn_mat_mult_nt_t_s4(input_data + input_start,
    //                                 filter_data,
    //                                 bias_data,
    //                                 output_data,
    ...
    //             status = muriscv_nn_mat_mul_core_1x_s4(ker_end_idx * input_ch,
    ...
    //     }
    // #else
    status = muriscv_nn_convolve_s4(ctx,
                                    conv_params,
                                    quant_params,
                                    input_dims,
                                    input_data,
