...
__STATIC_INLINE int32_t muriscv_nn_convolve_1_x_n_s8_get_buffer_size_mve(const muriscv_nn_dims *input_dims,
                                                                         const muriscv_nn_dims *filter_dims)
{
    (void)input_dims;
    (void)filter_dims;
...
/*
 * Get the required buffer size for muriscv_nn_convolve_wrapper_s8. This is the recommended function convolve wrapper s8
 * function.
 *
