 ...
 * Title:        muriscv_nn_depthwise_conv_s8_core.c
...
//
//        col_0_sum = muriscv_nn_requantize_mve_32x4(col_0_sum, mult, shift);
//        col_1_sum = muriscv_nn_requantize_mve_32x4(col_1_sum, mult, shift);
//
