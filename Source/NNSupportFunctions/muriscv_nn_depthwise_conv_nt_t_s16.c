 ...
 * Title:        muriscv_nn_depthwise_conv_nt_t_s16.c
...
//            }
//
//            out_0[i_requantize] = muriscv_nn_requantize_s64(in_requantize_0, reduced_multiplier, shift);
//            out_1[i_requantize] = muriscv_nn_requantize_s64(in_requantize_1, reduced_multiplier, shift);
//            out_2[i_requantize] = muriscv_nn_requantize_s64(in_requantize_2, reduced_multiplier, shift);
//            out_3[i_requantize] = muriscv_nn_requantize_s64(in_requantize_3, reduced_multiplier, shift);
//        }
//
