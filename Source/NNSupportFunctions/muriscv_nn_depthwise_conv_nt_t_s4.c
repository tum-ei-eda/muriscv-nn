 ...
 * Title:        muriscv_nn_depthwise_conv_nt_t_s4.c
                                                    ...
                                                    int8_t *out)
{
    ...
    //                 {
    //                     int8_t temp[] = {
    //                         rhs_0[0] >> 4, (int8_t)(rhs_0[1] << 4) >> 4, rhs_0[1] >> 4, (int8_t)(rhs_0[2] << 4) >>
    //                         4};
    ...
    //
    //         out_0 = muriscv_nn_requantize_mve_32x4(out_0, mult, shift);
    ...
    //
    //         out_1 = muriscv_nn_requantize_mve_32x4(out_1, mult, shift);
    ...
    //
    //         out_2 = muriscv_nn_requantize_mve_32x4(out_2, mult, shift);
    ...
    //
    //         out_3 = muriscv_nn_requantize_mve_32x4(out_3, mult, shift);
