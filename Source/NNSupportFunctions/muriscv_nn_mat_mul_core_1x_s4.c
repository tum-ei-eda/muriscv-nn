 ...
 * Title:        muriscv_nn_mat_mul_core_1x_s4.c
...
//                bias += 4;
//            }
//            res = muriscv_nn_requantize_mve_32x4(res, vldrwq_s32(output_mult), vldrwq_s32(output_shift));
//            output_mult += 4;
//            output_shift += 4;
...
//            acc_n0 += bias[i];
//        }
//        acc_n0 = muriscv_nn_requantize(acc_n0, output_mult[i], output_shift[i]);
