 ...
 * Title:        muriscv_nn_mat_mult_nt_interleaved_t_even_s4
                                                               ...
                                                               const int32_t lhs_cols_offset)
{
    ...
    //
    //             res = muriscv_nn_requantize_mve(res, dst_multipliers[i], dst_shifts[i]);
    ...
    //
    //             res = muriscv_nn_requantize_mve_pred(res, dst_multipliers[i], dst_shifts[i], requant_mask);
    ...
    //                 res = muriscv_nn_requantize_mve_32x4(res, vldrwq_s32(multipliers), vldrwq_s32(shifts));
    //                 multipliers += 4;
    //                 shifts += 4;
    //                 res = vaddq_n_s32(res, dst_offset);
    //                 res = vmaxq_s32(res, vdupq_n_s32(activation_min));
    ...
    //             acc_n0 = muriscv_nn_requantize(acc_n0, multipliers[i], shifts[i]);
    //             acc_n0 += dst_offset;
    ...
    //                 packed_rhs_ptr += 2;
    //
    //                 lhs_high = muriscv_nn_read_s8x4_ia((const int8_t **)&lhs_ptr);
    ...
    //
    //                 // 4 x MAC res10, res11
    //                 lhs_high = muriscv_nn_read_s8x4((const int8_t *)&lhs_ptr[lhs_cols_off1]);
    //                 lhs_low = SXTAB16(ui32_lhs_offset_i16x2, lhs_high);
    //                 lhs_high = SXTAB16_RORn(ui32_lhs_offset_i16x2, lhs_high, 8);
    //
    ...
    //             res01 = muriscv_nn_requantize(res01, dst_multipliers[rhs_rows_idx + 2], dst_shifts[rhs_rows_idx +
    //             2]); res10 = muriscv_nn_requantize(res10, dst_multipliers[rhs_rows_idx], dst_shifts[rhs_rows_idx]);
    //             res11 = muriscv_nn_requantize(res11, dst_multipliers[rhs_rows_idx + 2], dst_shifts[rhs_rows_idx +
    //             2]);
    //
    //             // Add offset
    //             res00 += dst_offset;
    ...
    //
    //             // Quantize down
    //             res00 = muriscv_nn_requantize(res00, dst_multipliers[rhs_rows_idx + 1], dst_shifts[rhs_rows_idx +
    //             1]); res01 = muriscv_nn_requantize(res01, dst_multipliers[rhs_rows_idx + 3], dst_shifts[rhs_rows_idx
    //             + 3]); res10 = muriscv_nn_requantize(res10, dst_multipliers[rhs_rows_idx + 1],
    //             dst_shifts[rhs_rows_idx + 1]); res11 = muriscv_nn_requantize(res11, dst_multipliers[rhs_rows_idx +
    //             3], dst_shifts[rhs_rows_idx + 3]);
    //
    //             // Add offset
    //             res00 += dst_offset;
    //             res01 += dst_offset;
    ...
    //
    //             // Quantize down
    //             res00 = muriscv_nn_requantize(
    //                 res00, dst_multipliers[rhs_rows_finished + rhs_rows_idx], dst_shifts[rhs_rows_finished +
    //                 rhs_rows_idx]);
    //             res10 = muriscv_nn_requantize(
    //                 res10, dst_multipliers[rhs_rows_finished + rhs_rows_idx], dst_shifts[rhs_rows_finished +
    //                 rhs_rows_idx]);
    //
    //             // Add offset
    //             res00 += dst_offset;
    ...
    for (int32_t rhs_rows_idx = 0; rhs_rows_idx <= (rhs_rows - 4); rhs_rows_idx += 4)
    {
        ...
        for (int32_t lhs_rows_idx = (lhs_rows >> 1); lhs_rows_idx > 0; --lhs_rows_idx)
        {
            ...
            // Quantize down
            res00 = muriscv_nn_requantize(res00, dst_multipliers[rhs_rows_idx], dst_shifts[rhs_rows_idx]);
            res01 = muriscv_nn_requantize(res01, dst_multipliers[rhs_rows_idx + 2], dst_shifts[rhs_rows_idx + 2]);
            res10 = muriscv_nn_requantize(res10, dst_multipliers[rhs_rows_idx], dst_shifts[rhs_rows_idx]);
            res11 = muriscv_nn_requantize(res11, dst_multipliers[rhs_rows_idx + 2], dst_shifts[rhs_rows_idx + 2]);
            ...
            // Quantize down
            res00 = muriscv_nn_requantize(res00, dst_multipliers[rhs_rows_idx + 1], dst_shifts[rhs_rows_idx + 1]);
            res01 = muriscv_nn_requantize(res01, dst_multipliers[rhs_rows_idx + 3], dst_shifts[rhs_rows_idx + 3]);
            res10 = muriscv_nn_requantize(res10, dst_multipliers[rhs_rows_idx + 1], dst_shifts[rhs_rows_idx + 1]);
            res11 = muriscv_nn_requantize(res11, dst_multipliers[rhs_rows_idx + 3], dst_shifts[rhs_rows_idx + 3]);
