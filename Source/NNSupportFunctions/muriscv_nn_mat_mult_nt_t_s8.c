 ...
 */
muriscv_nn_status
muriscv_nn_mat_mult_nt_t_s8(const q7_t *lhs,
                            const q7_t *rhs,
                            const q31_t *bias,
                            q7_t *dst,
                            ...
                            const int32_t lhs_cols_offset)
{
    ...
    int32_t activation_max_packed = (__rv_packu((uint8_t)activation_max, (uint8_t)activation_max)) |
        ((__rv_packu((uint8_t)activation_max, (uint8_t)activation_max)) << 8);
    int32_t activation_min_packed = (__rv_packu((uint8_t)activation_min, (uint8_t)activation_min)) |
        ((__rv_packu((uint8_t)activation_min, (uint8_t)activation_min)) << 8);
    int32_t dst_offset_packed = (__rv_packu((uint8_t)dst_offset, (uint8_t)dst_offset)) |
        ((__rv_packu((uint8_t)dst_offset, (uint8_t)dst_offset)) << 8);
