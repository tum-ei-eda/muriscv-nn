 ...
 * Title:        muriscv_nn_vec_mat_mul_result_acc_s16
...
//
//            int32_t tmp;
//            tmp = muriscv_nn_requantize_s64(result_64_0, reduced_multiplier, dst_shift);
//            tmp += (int64_t)*dst;
...
//
//            tmp = 0;
//            tmp = muriscv_nn_requantize_s64(result_64_1, reduced_multiplier, dst_shift);
//            tmp += (int64_t)*dst;
//            tmp = MAX(tmp, NN_Q15_MIN);
//            tmp = MIN(tmp, NN_Q15_MAX);
//            *dst++ = (int16_t)tmp;
//
//            tmp = 0;
//            tmp = muriscv_nn_requantize_s64(result_64_2, reduced_multiplier, dst_shift);
//            tmp += (int64_t)*dst;
//            tmp = MAX(tmp, NN_Q15_MIN);
//            tmp = MIN(tmp, NN_Q15_MAX);
//            *dst++ = (int16_t)tmp;
//
//            tmp = 0;
//            tmp = muriscv_nn_requantize_s64(result_64_3, reduced_multiplier, dst_shift);
//            tmp += (int64_t)*dst;
//            tmp = MAX(tmp, NN_Q15_MIN);
//            tmp = MIN(tmp, NN_Q15_MAX);
//            *dst++ = (int16_t)tmp;
...
//
//            int32_t tmp = 0;
//            tmp = muriscv_nn_requantize_s64(result_64, reduced_multiplier, dst_shift);
//            tmp += (int64_t)*dst;
//            tmp = MAX(tmp, NN_Q15_MIN);
//            tmp = MIN(tmp, NN_Q15_MAX);
//            *dst++ = (int16_t)tmp;
