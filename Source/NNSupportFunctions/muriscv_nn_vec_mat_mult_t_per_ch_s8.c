 ...
 * Title:        muriscv_nn_vec_mat_mult_t_per_ch_s8
 ...
 *
 */
//#if !defined(USE_VEXT) && defined(USE_PEXT) && !defined(__ARMCC_VERSION) && !defined(__ICCARM__)
...
//
//            acc = muriscv_nn_requantize_mve(acc, *dst_multiplier++, *dst_shift++);
//
...
//
//                ker_0 = muriscv_nn_read_s8x4_ia(&rhs_1_ptr);
...
//                vec_0 = SXTAB16(lhs_offset_s16x2, vec_0);
//
//                int32_t ker_0 = muriscv_nn_read_s8x4_ia(&rhs_ptr);
//                int32_t ker_1 = SXTAB16_RORn(rhs_offset_s16x2, (uint32_t)ker_0, 8);
//                ker_0 = SXTAB16(rhs_offset_s16x2, ker_0);
//
//                acc_0 = SMLAD(ker_1, vec_1, acc_0);
...
//            int32x4_t acc = {acc_0, acc_1, acc_2, acc_3};
//
//            acc = muriscv_nn_requantize_mve_32x4(acc, vldrwq_s32(dst_multiplier), vldrwq_s32(dst_shift));
//            dst_multiplier += 4;
//            dst_shift += 4;
//
//            acc = vaddq_s32(acc, vdupq_n_s32(dst_offset));
