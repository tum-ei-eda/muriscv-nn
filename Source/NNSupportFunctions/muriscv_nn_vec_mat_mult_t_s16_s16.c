 ...
 * Title:        muriscv_nn_vec_mat_mult_t_s16_s16
...
//
//        int32_t tmp;
//        tmp = muriscv_nn_requantize_s64(result_0, dst_multiplier, dst_shift);
//        tmp = MAX(tmp, activation_min);
//        tmp = MIN(tmp, activation_max);
//        *dst++ = (int16_t)tmp;
//
//        tmp = 0;
//        tmp = muriscv_nn_requantize_s64(result_1, dst_multiplier, dst_shift);
//        tmp = MAX(tmp, activation_min);
//        tmp = MIN(tmp, activation_max);
//        *dst++ = (int16_t)tmp;
//
//        tmp = 0;
//        tmp = muriscv_nn_requantize_s64(result_2, dst_multiplier, dst_shift);
//        tmp = MAX(tmp, activation_min);
//        tmp = MIN(tmp, activation_max);
//        *dst++ = (int16_t)tmp;
//
//        tmp = 0;
//        tmp = muriscv_nn_requantize_s64(result_3, dst_multiplier, dst_shift);
//        tmp = MAX(tmp, activation_min);
//        tmp = MIN(tmp, activation_max);
//        *dst++ = (int16_t)tmp;
//
...
//
//        int32_t tmp = 0;
//        tmp = muriscv_nn_requantize_s64(result, dst_multiplier, dst_shift);
//        tmp = MAX(tmp, activation_min);
//        tmp = MIN(tmp, activation_max);
//        *dst++ = (int16_t)tmp;
//
...
//
//            ker_0 = muriscv_nn_read_q15x2_ia(&rhs_0);
//            ker_1 = muriscv_nn_read_q15x2_ia(&rhs_0);
//
//            acc_0 = SMLALD(ker_0, vec_part_0, acc_0);
//            acc_0 = SMLALD(ker_1, vec_part_1, acc_0);
//
//            ker_0 = muriscv_nn_read_q15x2_ia(&rhs_1);
//            ker_1 = muriscv_nn_read_q15x2_ia(&rhs_1);
//
...
//        int32_t tmp;
//
//        tmp = muriscv_nn_requantize_s64(acc_0, dst_multiplier, dst_shift);
//        tmp = MAX(tmp, activation_min);
//        tmp = MIN(tmp, activation_max);
//        *dst++ = (int16_t)tmp;
//
//        tmp = muriscv_nn_requantize_s64(acc_1, dst_multiplier, dst_shift);
//        tmp = MAX(tmp, activation_min);
//        tmp = MIN(tmp, activation_max);
//        *dst++ = (int16_t)tmp;
//    }
