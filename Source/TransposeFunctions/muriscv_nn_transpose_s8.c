 ...
 * Title:        muriscv_nn_transpose_s8.c
                                     ...
                                     const muriscv_nn_transpose_params *const transpose_params)
{
    ...
    {
        muriscv_nn_memcpy_s8(output, input, input_dims->n);

        return MURISCV_NN_SUCCESS;
    }
    else if (transpose_params->num_dims == 2)
    {
        const muriscv_nn_dims smaller_input_dims = {1, 1, n, h};

        return muriscv_nn_transpose_s8_nhcw(input, output, &smaller_input_dims, in_strides, out_strides);
    }
    else if (transpose_params->num_dims == 3)
    {
        const muriscv_nn_dims smaller_input_dims = {1, n, h, w};
        ...
        return muriscv_nn_transpose_s8_default(input, output, &smaller_input_dims, in_strides, out_strides);
    }
