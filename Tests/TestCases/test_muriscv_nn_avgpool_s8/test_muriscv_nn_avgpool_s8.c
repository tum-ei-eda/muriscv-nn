...
{
//#if defined(USE_VEXT)
//    const int32_t buf_size = muriscv_nn_avgpool_s8_get_buffer_size(AVGPOOLING_5_OUTPUT_W, AVGPOOLING_5_IN_CH);
//    const int32_t mve_buf_size = muriscv_nn_avgpool_s8_get_buffer_size_mve(AVGPOOLING_5_OUTPUT_W, AVGPOOLING_5_IN_CH);
//
...
//    const int32_t buf_size = muriscv_nn_avgpool_s8_get_buffer_size(AVGPOOLING_5_OUTPUT_W, AVGPOOLING_5_IN_CH);
//    const int32_t dsp_buf_size = muriscv_nn_avgpool_s8_get_buffer_size_dsp(AVGPOOLING_5_OUTPUT_W, AVGPOOLING_5_IN_CH);
//
