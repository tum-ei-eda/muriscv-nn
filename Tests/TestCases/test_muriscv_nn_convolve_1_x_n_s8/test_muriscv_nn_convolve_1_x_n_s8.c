...
void conv_1_x_n_4_muriscv_nn_convolve_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void conv_1_x_n_5_muriscv_nn_convolve_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void conv_1_x_n_6_muriscv_nn_convolve_s8(void)
{
    int8_t output[CONV_1_X_N_3_DST_SIZE] = {0};
...
void conv_1_x_n_7_muriscv_nn_convolve_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void conv_1_x_n_6_generic_muriscv_nn_convolve_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void conv_1_x_n_8_muriscv_nn_convolve_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
