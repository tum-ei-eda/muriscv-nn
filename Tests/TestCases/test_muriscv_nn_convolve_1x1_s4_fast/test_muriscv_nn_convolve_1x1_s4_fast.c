...
void kernel1x1_muriscv_nn_convolve_1x1_s4_fast(void)
{
    ...
    const int32_t buf_size = muriscv_nn_convolve_1x1_s4_fast_get_buffer_size(&input_dims);
    ctx.buf = malloc(buf_size);
    ctx.size = 0;

    muriscv_nn_status result = muriscv_nn_convolve_1x1_s4_fast(&ctx,
                                                          &conv_params,
                                                          &quant_params,
                                                          &input_dims,
                                                          input_data,
...
void kernel1x1_2_muriscv_nn_convolve_1x1_s4_fast(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void kernel1x1_3_muriscv_nn_convolve_1x1_s4_fast(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void kernel1x1_stride_x_muriscv_nn_convolve_1x1_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
    ...
    result = muriscv_nn_convolve_1x1_s4(&ctx,
                                 &conv_params,
                                 &quant_params,
                                 &input_dims,
                                 input_data,
...
void kernel1x1_stride_x_y_muriscv_nn_convolve_1x1_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void kernel1x1_stride_x_y_1_muriscv_nn_convolve_1x1_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
    ...
    muriscv_nn_status result = muriscv_nn_convolve_1x1_s4(&ctx,
                                                     &conv_params,
                                                     &quant_params,
                                                     &input_dims,
                                                     input_data,
...
void kernel1x1_stride_x_y_2_muriscv_nn_convolve_1x1_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void buffer_size_muriscv_nn_convolve_1x1_s4_fast(void)
{
    muriscv_nn_conv_params conv_params;
    muriscv_nn_dims input_dims;
    muriscv_nn_dims filter_dims;
...
void buffer_size_mve_muriscv_nn_convolve_1x1_s4_fast(void)
{
//#if defined(USE_VEXT)
//    muriscv_nn_conv_params conv_params;
//    muriscv_nn_dims input_dims;
...
void buffer_size_dsp_muriscv_nn_convolve_1x1_s4_fast(void)
{
