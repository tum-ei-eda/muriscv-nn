...
void kernel1x1_stride_x_muriscv_nn_convolve_1x1_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void kernel1x1_stride_x_y_muriscv_nn_convolve_1x1_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void kernel1x1_stride_x_y_1_muriscv_nn_convolve_1x1_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void kernel1x1_stride_x_y_2_muriscv_nn_convolve_1x1_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void buffer_size_muriscv_nn_convolve_1x1_s8_fast(void)
{
    muriscv_nn_conv_params conv_params;
    muriscv_nn_dims input_dims;
    muriscv_nn_dims filter_dims;
...
void buffer_size_mve_muriscv_nn_convolve_1x1_s8_fast(void)
{
#if defined(USE_VEXT)
    muriscv_nn_conv_params conv_params;
    muriscv_nn_dims input_dims;
    ...
    const int32_t mve_wrapper_buf_size =
        muriscv_nn_convolve_wrapper_s8_get_buffer_size_mve(&conv_params, &input_dims, &filter_dims, &output_dims);

    TEST_ASSERT_EQUAL(wrapper_buf_size, mve_wrapper_buf_size);
#endif
}

void buffer_size_dsp_muriscv_nn_convolve_1x1_s8_fast(void)
{
    ...
    const int32_t dsp_wrapper_buf_size =
        muriscv_nn_convolve_wrapper_s8_get_buffer_size_dsp(&conv_params, &input_dims, &filter_dims, &output_dims);
...
int main(void)
{
    ...
    RUN_TEST(kernel1x1_stride_x_muriscv_nn_convolve_1x1_s8);
    RUN_TEST(kernel1x1_stride_x_y_muriscv_nn_convolve_1x1_s8);
    RUN_TEST(kernel1x1_stride_x_y_1_muriscv_nn_convolve_1x1_s8);
    RUN_TEST(kernel1x1_stride_x_y_2_muriscv_nn_convolve_1x1_s8);
    RUN_TEST(buffer_size_muriscv_nn_convolve_1x1_s8_fast);
    RUN_TEST(buffer_size_mve_muriscv_nn_convolve_1x1_s8_fast);
    RUN_TEST(buffer_size_dsp_muriscv_nn_convolve_1x1_s8_fast);
