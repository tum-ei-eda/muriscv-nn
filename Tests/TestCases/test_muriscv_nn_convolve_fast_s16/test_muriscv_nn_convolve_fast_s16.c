...
void int16xint8_muriscv_nn_convolve_fast_s16(void)
{
    ...
    muriscv_nn_status result = muriscv_nn_convolve_wrapper_s16(&ctx,
                                                               &conv_params,
                                                               &quant_params,
                                                               &input_dims,
                                                               input_data,
    ...
    buf_size = muriscv_nn_convolve_fast_s16_get_buffer_size(&input_dims, &filter_dims);
    ctx.buf = malloc(buf_size);

    result = muriscv_nn_convolve_fast_s16(&ctx,
                                          &conv_params,
                                          &quant_params,
                                          &input_dims,
                                          input_data,
...
void requantize_s64_muriscv_nn_convolve_fast_s16(void)
{
...
int main(void)
{
    ...
    RUN_TEST(int16xint8_muriscv_nn_convolve_fast_s16);
    RUN_TEST(requantize_s64_muriscv_nn_convolve_fast_s16);
