...
void basic_muriscv_nn_convolve_s4(void)
{
    ...
    int32_t buf_size = muriscv_nn_convolve_s4_get_buffer_size(&input_dims, &filter_dims);
    ctx.buf = malloc(buf_size);
    ctx.size = 0;

    muriscv_nn_status result = muriscv_nn_convolve_s4(&ctx,
                                                 &conv_params,
                                                 &quant_params,
                                                 &input_dims,
                                                 input_data,
    ...
    buf_size = muriscv_nn_convolve_wrapper_s4_get_buffer_size(&conv_params, &input_dims, &filter_dims, &output_dims);
    ctx.buf = malloc(buf_size);
    ctx.size = 0;

    result = muriscv_nn_convolve_wrapper_s4(&ctx,
                                     &conv_params,
                                     &quant_params,
                                     &input_dims,
                                     input_data,
...
void basic_2_muriscv_nn_convolve_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void stride2pad1_muriscv_nn_convolve_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void conv_2_muriscv_nn_convolve_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void conv_3_muriscv_nn_convolve_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void conv_4_muriscv_nn_convolve_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void conv_out_activation_muriscv_nn_convolve_s4(void)
{
    ...
    int32_t buf_size = muriscv_nn_convolve_wrapper_s4_get_buffer_size(&conv_params, &input_dims, &filter_dims, &output_dims);
    ctx.buf = malloc(buf_size);

    muriscv_nn_status result = muriscv_nn_convolve_wrapper_s4(&ctx,
                                                         &conv_params,
                                                         &quant_params,
                                                         &input_dims,
                                                         input_data,
...
void conv_2x2_dilation_muriscv_nn_convolve_s4(void)
{
...
void conv_2x2_dilation_5x5_input_muriscv_nn_convolve_s4(void)
{
...
void conv_3x3_dilation_5x5_input_muriscv_nn_convolve_s4(void)
{
...
void conv_2x3_dilation_muriscv_nn_convolve_s4(void)
{
...
void conv_3x2_dilation_muriscv_nn_convolve_s4(void)
{
...
void conv_dilation_golden_muriscv_nn_convolve_s4(void)
{
...
void conv_5_muriscv_nn_convolve_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void buffer_size_muriscv_nn_convolve_s4(void)
{
    muriscv_nn_conv_params conv_params;
    muriscv_nn_dims input_dims;
    muriscv_nn_dims filter_dims;
    ...
    const int32_t buf_size = muriscv_nn_convolve_s4_get_buffer_size(&input_dims, &filter_dims);
    const int32_t wrapper_buf_size =
        muriscv_nn_convolve_wrapper_s4_get_buffer_size(&conv_params, &input_dims, &filter_dims, &output_dims);

    TEST_ASSERT_EQUAL(wrapper_buf_size, buf_size);
}

void buffer_size_mve_muriscv_nn_convolve_s4(void)
{
//#if defined(USE_VEXT)
//    muriscv_nn_conv_params conv_params;
//    muriscv_nn_dims input_dims;
...
//        muriscv_nn_convolve_wrapper_s4_get_buffer_size_mve(&conv_params, &input_dims, &filter_dims, &output_dims);
//
//    TEST_ASSERT_EQUAL(wrapper_buf_size, mve_wrapper_buf_size);
//#endif
}

void buffer_size_dsp_muriscv_nn_convolve_s4(void)
{
...
//        muriscv_nn_convolve_wrapper_s4_get_buffer_size_dsp(&conv_params, &input_dims, &filter_dims, &output_dims);
//
//    TEST_ASSERT_EQUAL(wrapper_buf_size, dsp_wrapper_buf_size);
//#endif
}

void conv_1_x_n_1_muriscv_nn_convolve_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
    ...
    result = muriscv_nn_convolve_1_x_n_s4(&ctx,
                                   &conv_params,
                                   &quant_params,
                                   &input_dims,
                                   input_data,
...
void conv_1_x_n_2_muriscv_nn_convolve_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void conv_1_x_n_3_muriscv_nn_convolve_s4(void)
{
...
void conv_1_x_n_4_muriscv_nn_convolve_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void conv_1_x_n_5_muriscv_nn_convolve_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
