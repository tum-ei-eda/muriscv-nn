...
void conv_out_activation_muriscv_nn_convolve_s8(void)
{
    ...
    int32_t buf_size = muriscv_nn_convolve_wrapper_s8_get_buffer_size(&conv_params, &input_dims, &filter_dims, &output_dims);
    ctx.buf = malloc(buf_size);
...
void conv_5_muriscv_nn_convolve_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void buffer_size_muriscv_nn_convolve_s8(void)
{
    muriscv_nn_conv_params conv_params;
    muriscv_nn_dims input_dims;
    muriscv_nn_dims filter_dims;
    ...
    const int32_t buf_size = muriscv_nn_convolve_s8_get_buffer_size(&input_dims, &filter_dims);
...
void buffer_size_mve_muriscv_nn_convolve_s8(void)
{
#if defined(USE_VEXT)
    muriscv_nn_conv_params conv_params;
    muriscv_nn_dims input_dims;
...
void buffer_size_dsp_muriscv_nn_convolve_s8(void)
{
...
int main(void)
{
    ...
    RUN_TEST(conv_5_muriscv_nn_convolve_s8);
    // RUN_TEST(conv_1_x_n_1_muriscv_nn_convolve_s8);  // moved to new dir
    ...
    RUN_TEST(buffer_size_muriscv_nn_convolve_s8);
    RUN_TEST(buffer_size_mve_muriscv_nn_convolve_s8);
    RUN_TEST(buffer_size_dsp_muriscv_nn_convolve_s8);
