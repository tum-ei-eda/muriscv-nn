...
void depthwise_kernel_3x3_null_bias_muriscv_nn_depthwise_conv_3x3_null_bias_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void stride2pad1_muriscv_nn_depthwise_conv_3x3_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void buffer_size_mve_muriscv_nn_depthwise_conv_3x3_s8(void)
{
#if defined(USE_VEXT)
...
void buffer_size_dsp_muriscv_nn_depthwise_conv_3x3_s8(void)
{
...
int main(void)
{
    ...
    // RUN_TEST(depthwise_kernel_3x3_muriscv_nn_depthwise_conv_3x3_2_s8); // old?
    RUN_TEST(depthwise_kernel_3x3_null_bias_muriscv_nn_depthwise_conv_3x3_null_bias_s8);
    RUN_TEST(stride2pad1_muriscv_nn_depthwise_conv_3x3_s8);
    RUN_TEST(buffer_size_mve_muriscv_nn_depthwise_conv_3x3_s8);
    RUN_TEST(buffer_size_dsp_muriscv_nn_depthwise_conv_3x3_s8);
