...
void dw_int16xint8_fast_null_bias_muriscv_nn_depthwise_conv_fast_s16(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void dw_int16xint8_fast_stride_null_bias_muriscv_nn_depthwise_conv_fast_s16(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void dw_int16xint8_fast_spill_null_bias_muriscv_nn_depthwise_conv_fast_s16(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void dw_int16xint8_fast_test_bias_muriscv_nn_depthwise_conv_fast_s16(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void dw_int16xint8_fast_multiple_batches_uneven_buffers_muriscv_nn_depthwise_conv_fast_s16(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void dw_int16xint8_fast_multiple_batches_uneven_buffers_null_bias_muriscv_nn_depthwise_conv_fast_s16(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void buffer_size_muriscv_nn_depthwise_conv_fast_s16(void)
{
    ...
    const int32_t buf_size = muriscv_nn_depthwise_conv_fast_s16_get_buffer_size(&input_dims, &filter_dims);
...
void buffer_size_mve_muriscv_nn_depthwise_conv_fast_s16(void)
{
#if defined(USE_VEXT)
    muriscv_nn_dw_conv_params conv_params;
    muriscv_nn_dims input_dims;
...
void buffer_size_dsp_muriscv_nn_depthwise_conv_fast_s16(void)
{
...
int main(void)
{
    ...
    RUN_TEST(dw_int16xint8_fast_null_bias_muriscv_nn_depthwise_conv_fast_s16);
    RUN_TEST(dw_int16xint8_fast_stride_null_bias_muriscv_nn_depthwise_conv_fast_s16);
    RUN_TEST(dw_int16xint8_fast_spill_null_bias_muriscv_nn_depthwise_conv_fast_s16);
    RUN_TEST(dw_int16xint8_fast_test_bias_muriscv_nn_depthwise_conv_fast_s16);
    RUN_TEST(dw_int16xint8_fast_multiple_batches_uneven_buffers_muriscv_nn_depthwise_conv_fast_s16);
    RUN_TEST(dw_int16xint8_fast_multiple_batches_uneven_buffers_null_bias_muriscv_nn_depthwise_conv_fast_s16);
    RUN_TEST(buffer_size_muriscv_nn_depthwise_conv_fast_s16);
    RUN_TEST(buffer_size_mve_muriscv_nn_depthwise_conv_fast_s16);
    RUN_TEST(buffer_size_dsp_muriscv_nn_depthwise_conv_fast_s16);
