...
void depthwise_int4_generic_muriscv_nn_depthwise_conv_s4(void)
{
    ...
    ctx.size = muriscv_nn_depthwise_conv_wrapper_s4_get_buffer_size(&dw_conv_params, &input_dims, &filter_dims, &output_dims);
    TEST_ASSERT_TRUE(ctx.size == 0);

    ctx.buf = malloc(ctx.size);

    muriscv_nn_status result = muriscv_nn_depthwise_conv_s4(&ctx,
                                                       &dw_conv_params,
                                                       &quant_params,
                                                       &input_dims,
                                                       input_data,
    ...
    ctx.buf = malloc(ctx.size);
    result = muriscv_nn_depthwise_conv_wrapper_s4(&ctx,
                                           &dw_conv_params,
                                           &quant_params,
                                           &input_dims,
                                           input_data,
...
void depthwise_int4_generic_2_muriscv_nn_depthwise_conv_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void depthwise_int4_generic_3_muriscv_nn_depthwise_conv_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void depthwise_int4_generic_4_muriscv_nn_depthwise_conv_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void depthwise_int4_generic_5_muriscv_nn_depthwise_conv_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void depthwise_int4_generic_6_muriscv_nn_depthwise_conv_s4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
