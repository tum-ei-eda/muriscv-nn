...
void basic_muriscv_nn_depthwise_conv_s8_opt(void)
{
    ...
    muriscv_nn_status result = muriscv_nn_depthwise_conv_s8_opt(&ctx,
                                                           &dw_conv_params,
                                                           &quant_params,
                                                           &input_dims,
                                                           input_data,
...
void depthwise_sub_block_muriscv_nn_depthwise_conv_s8_opt(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void depthwise_out_activation_muriscv_nn_depthwise_conv_s8_opt(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void depthwise_null_bias_0_muriscv_nn_depthwise_conv_s8_opt(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void depthwise_x_stride_muriscv_nn_depthwise_conv_s8_opt(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void buffer_size_muriscv_nn_depthwise_conv_s8_opt(void)
{
    ...
    const int32_t buf_size = muriscv_nn_depthwise_conv_s8_opt_get_buffer_size(&input_dims, &filter_dims);
    const int32_t wrapper_buf_size =
        muriscv_nn_depthwise_conv_wrapper_s8_get_buffer_size(&conv_params, &input_dims, &filter_dims, &output_dims);

    TEST_ASSERT_EQUAL(wrapper_buf_size, buf_size);
}

void buffer_size_mve_muriscv_nn_depthwise_conv_s8_opt(void)
{
#if defined(USE_VEXT)
    muriscv_nn_dw_conv_params conv_params;
    muriscv_nn_dims input_dims;
    ...
    const int32_t mve_wrapper_buf_size =
        muriscv_nn_depthwise_conv_wrapper_s8_get_buffer_size_mve(&conv_params, &input_dims, &filter_dims, &output_dims);

    TEST_ASSERT_EQUAL(wrapper_buf_size, mve_wrapper_buf_size);
#endif
}

void buffer_size_dsp_muriscv_nn_depthwise_conv_s8_opt(void)
{
    ...
    const int32_t dsp_wrapper_buf_size =
        muriscv_nn_depthwise_conv_wrapper_s8_get_buffer_size_dsp(&conv_params, &input_dims, &filter_dims, &output_dims);
...
int main(void)
{
    ...
    RUN_TEST(basic_muriscv_nn_depthwise_conv_s8_opt);
    // RUN_TEST(stride2pad1_muriscv_nn_depthwise_conv_s8_opt);  // old?
    RUN_TEST(depthwise_eq_in_out_ch_muriscv_nn_depthwise_conv_s8_opt);
    RUN_TEST(depthwise_sub_block_muriscv_nn_depthwise_conv_s8_opt);
    RUN_TEST(depthwise_out_activation_muriscv_nn_depthwise_conv_s8_opt);
    RUN_TEST(depthwise_null_bias_0_muriscv_nn_depthwise_conv_s8_opt);
    RUN_TEST(depthwise_x_stride_muriscv_nn_depthwise_conv_s8_opt);
    RUN_TEST(buffer_size_muriscv_nn_depthwise_conv_s8_opt);
    RUN_TEST(buffer_size_mve_muriscv_nn_depthwise_conv_s8_opt);
    RUN_TEST(buffer_size_dsp_muriscv_nn_depthwise_conv_s8_opt);
