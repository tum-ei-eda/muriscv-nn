...
int ds_cnn_l_s8_get_buffer_size(void)
{
    /* Custom function based on knowledge that only select layers of DS_CNN_L network require additional buffers. */
    int max_buffer = 0;
    ...
    int32_t size = muriscv_nn_convolve_wrapper_s8_get_buffer_size(&conv_params, &input_dims, &filter_dims, &output_dims);
    ...
    size = muriscv_nn_depthwise_conv_wrapper_s8_get_buffer_size(&dw_conv_params, &input_dims, &filter_dims, &output_dims);
    ...
    input_dims.n = 1;
    input_dims.h = DEPTHWISE_CONV_2D_4_INPUT_H;
    input_dims.w = DEPTHWISE_CONV_2D_4_INPUT_W;
    input_dims.c = DEPTHWISE_CONV_2D_4_IN_CH;

    filter_dims.h = DEPTHWISE_CONV_2D_4_FILTER_H;
    filter_dims.w = DEPTHWISE_CONV_2D_4_FILTER_W;

    output_dims.n = 1;
    output_dims.h = 1;
    output_dims.w = DEPTHWISE_CONV_2D_4_OUTPUT_W;
    output_dims.c = DEPTHWISE_CONV_2D_4_OUTPUT_H;
...
void ds_cnn_l_s8_inference(void)
{
    /* Test for a complete int8 DS_CNN_L keyword spotting network from https://github.com/ARM-software/ML-zoo &
     * Tag: 22.02 */
    muriscv_nn_context ctx;
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;

    ctx.size = ds_cnn_l_s8_get_buffer_size();
    ...
    muriscv_nn_dims in_out_dim_0;
    muriscv_nn_dims conv_filter_dims;
    muriscv_nn_dims dw_conv_filter_dims;
    muriscv_nn_dims in_out_dim_1;
    ...
    quant_params.multiplier = (int32_t *)ds_cnn_l_layer_1_conv_2d_output_mult;
    quant_params.shift = (int32_t *)ds_cnn_l_layer_1_conv_2d_output_shift;
    ...
    muriscv_nn_status status = muriscv_nn_convolve_wrapper_s8(&ctx,
                                                         &conv_params,
                                                         &quant_params,
                                                         &in_out_dim_0,
                                                         ds_cnn_l_input,
                                                         &conv_filter_dims,
                                                         ds_cnn_l_layer_1_conv_2d_weights,
                                                         &bias_dims,
                                                         ds_cnn_l_layer_1_conv_2d_bias,
                                                         &in_out_dim_1,
                                                         in_out_buf_0);
    ...
    quant_params.multiplier = (int32_t *)ds_cnn_l_layer_2_depthwise_conv_2d_output_mult;
    quant_params.shift = (int32_t *)ds_cnn_l_layer_2_depthwise_conv_2d_output_shift;
    ...
    status |= muriscv_nn_depthwise_conv_wrapper_s8(&ctx,
                                            &dw_conv_params,
                                            &quant_params,
                                            &in_out_dim_1,
                                            in_out_buf_0,
    ...
    quant_params.multiplier = (int32_t *)ds_cnn_l_layer_3_conv_2d_output_mult;
    quant_params.shift = (int32_t *)ds_cnn_l_layer_3_conv_2d_output_shift;
    ...
    status |= muriscv_nn_convolve_wrapper_s8(&ctx,
                                      ...
                                      in_out_buf_1,
                                      &conv_filter_dims,
                                      ds_cnn_l_layer_3_conv_2d_weights,
                                      &bias_dims,
                                      ds_cnn_l_layer_3_conv_2d_bias,
                                      &in_out_dim_1,
                                      in_out_buf_0);

    /***************************** Depthwise Separable Block 2 *************** */
    // Common params for DW conv in subsequent layers
    dw_conv_params.padding.h = DEPTHWISE_CONV_2D_4_PAD_H;
    dw_conv_params.padding.w = DEPTHWISE_CONV_2D_4_PAD_W;
    dw_conv_params.stride.h = DEPTHWISE_CONV_2D_4_STRIDE_H;
    dw_conv_params.stride.w = DEPTHWISE_CONV_2D_4_STRIDE_W;
    ...
    quant_params.multiplier = (int32_t *)ds_cnn_l_layer_4_depthwise_conv_2d_output_mult;
    quant_params.shift = (int32_t *)ds_cnn_l_layer_4_depthwise_conv_2d_output_shift;
    ...
    quant_params.multiplier = (int32_t *)ds_cnn_l_layer_5_conv_2d_output_mult;
    quant_params.shift = (int32_t *)ds_cnn_l_layer_5_conv_2d_output_shift;
    ...
    status |= muriscv_nn_convolve_wrapper_s8(&ctx,
                                      ...
                                      in_out_buf_1,
                                      &conv_filter_dims,
                                      ds_cnn_l_layer_5_conv_2d_weights,
                                      &bias_dims,
                                      ds_cnn_l_layer_5_conv_2d_bias,
                                      &in_out_dim_1,
                                      in_out_buf_0);
    ...
    quant_params.multiplier = (int32_t *)ds_cnn_l_layer_6_depthwise_conv_2d_output_mult;
    quant_params.shift = (int32_t *)ds_cnn_l_layer_6_depthwise_conv_2d_output_shift;
    ...
    quant_params.multiplier = (int32_t *)ds_cnn_l_layer_7_conv_2d_output_mult;
    quant_params.shift = (int32_t *)ds_cnn_l_layer_7_conv_2d_output_shift;
    ...
    status |= muriscv_nn_convolve_wrapper_s8(&ctx,
                                      ...
                                      in_out_buf_1,
                                      &conv_filter_dims,
                                      ds_cnn_l_layer_7_conv_2d_weights,
                                      &bias_dims,
                                      ds_cnn_l_layer_7_conv_2d_bias,
                                      &in_out_dim_1,
                                      in_out_buf_0);
    ...
    quant_params.multiplier = (int32_t *)ds_cnn_l_layer_8_depthwise_conv_2d_output_mult;
    quant_params.shift = (int32_t *)ds_cnn_l_layer_8_depthwise_conv_2d_output_shift;
    ...
    quant_params.multiplier = (int32_t *)ds_cnn_l_layer_9_conv_2d_output_mult;
    quant_params.shift = (int32_t *)ds_cnn_l_layer_9_conv_2d_output_shift;
    ...
    status |= muriscv_nn_convolve_wrapper_s8(&ctx,
                                      ...
                                      in_out_buf_1,
                                      &conv_filter_dims,
                                      ds_cnn_l_layer_9_conv_2d_weights,
                                      &bias_dims,
                                      ds_cnn_l_layer_9_conv_2d_bias,
                                      &in_out_dim_1,
                                      in_out_buf_0);

    /***************************** Depthwise Separable Block 5 *************** */
    dw_conv_params.input_offset = DEPTHWISE_CONV_2D_10_INPUT_OFFSET;
    dw_conv_params.output_offset = DEPTHWISE_CONV_2D_10_OUTPUT_OFFSET;

    quant_params.multiplier = (int32_t *)ds_cnn_l_layer_10_depthwise_conv_2d_output_mult;
    quant_params.shift = (int32_t *)ds_cnn_l_layer_10_depthwise_conv_2d_output_shift;
    ...
    conv_params.input_offset = CONV_2D_11_INPUT_OFFSET;
    conv_params.output_offset = CONV_2D_11_OUTPUT_OFFSET;

    quant_params.multiplier = (int32_t *)ds_cnn_l_layer_11_conv_2d_output_mult;
    quant_params.shift = (int32_t *)ds_cnn_l_layer_11_conv_2d_output_shift;
    ...
    status |= muriscv_nn_convolve_wrapper_s8(&ctx,
                                      ...
                                      in_out_buf_1,
                                      &conv_filter_dims,
                                      ds_cnn_l_layer_11_conv_2d_weights,
                                      &bias_dims,
                                      ds_cnn_l_layer_11_conv_2d_bias,
                                      &in_out_dim_1,
                                      in_out_buf_0);
    ...
    pool_params.activation.max = AVERAGE_POOL_2D_12_OUT_ACTIVATION_MAX;
    pool_params.activation.min = AVERAGE_POOL_2D_12_OUT_ACTIVATION_MIN;
    pool_params.padding.h = AVERAGE_POOL_2D_12_PAD_H;
    pool_params.padding.w = AVERAGE_POOL_2D_12_PAD_W;
    pool_params.stride.h = AVERAGE_POOL_2D_12_STRIDE_H;
    pool_params.stride.w = AVERAGE_POOL_2D_12_STRIDE_W;

    conv_filter_dims.h = AVERAGE_POOL_2D_12_FILTER_H;
    conv_filter_dims.w = AVERAGE_POOL_2D_12_FILTER_W;

    in_out_dim_0.n = 1;
    in_out_dim_0.h = AVERAGE_POOL_2D_12_OUTPUT_H;
    in_out_dim_0.w = AVERAGE_POOL_2D_12_OUTPUT_W;
    in_out_dim_0.c = in_out_dim_1.c;

    status |=
        muriscv_nn_avgpool_s8(&ctx, &pool_params, &in_out_dim_1, in_out_buf_0, &conv_filter_dims, &in_out_dim_0, in_out_buf_1);

    /***************************** Fully Connected ****************/
    muriscv_nn_fc_params fc_params;
    fc_params.activation.max = FULLY_CONNECTED_14_OUT_ACTIVATION_MAX;
    fc_params.activation.min = FULLY_CONNECTED_14_OUT_ACTIVATION_MIN;
    fc_params.filter_offset = 0;
    fc_params.input_offset = FULLY_CONNECTED_14_INPUT_OFFSET;
    fc_params.output_offset = FULLY_CONNECTED_14_OUTPUT_OFFSET;

    muriscv_nn_per_tensor_quant_params per_tensor_quant_params;
    per_tensor_quant_params.multiplier = FULLY_CONNECTED_14_OUTPUT_MULTIPLIER;
    per_tensor_quant_params.shift = FULLY_CONNECTED_14_OUTPUT_SHIFT;
    ...
    conv_filter_dims.c = FULLY_CONNECTED_14_OUTPUT_W;
...
//#if defined(USE_VEXT)
//    muriscv_nn_vector_sum_s8(ctx.buf, conv_filter_dims.n, in_out_dim_1.c, ds_cnn_l_layer_14_fully_connected_weights, 1, NULL);
//#endif

    status |= muriscv_nn_fully_connected_s8(&ctx,
                                     &fc_params,
    ...
    muriscv_nn_softmax_s8(in_out_buf_0,
                   SOFTMAX_15_NUM_ROWS,
                   SOFTMAX_15_ROW_SIZE,
                   SOFTMAX_15_MULT,
                   SOFTMAX_15_SHIFT,
    ...
    TEST_ASSERT_TRUE(validate(in_out_buf_0, ds_cnn_l_output_ref, sizeof(ds_cnn_l_output_ref)));
}
