...
void add_s16_muriscv_nn_elementwise_add_s16(void)
{
    ...
    muriscv_nn_status result = muriscv_nn_elementwise_add_s16(input_data1,
                                                              input_data2,
                                                              input_1_offset,
                                                              input_1_mult,
                                                              input_1_shift,
...
void add_s16_spill_muriscv_nn_elementwise_add_s16(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
int main(void)
{
    ...
    RUN_TEST(add_s16_muriscv_nn_elementwise_add_s16);
    RUN_TEST(add_s16_spill_muriscv_nn_elementwise_add_s16);
