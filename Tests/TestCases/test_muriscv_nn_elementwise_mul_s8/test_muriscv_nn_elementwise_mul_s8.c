...
void mul_muriscv_nn_elementwise_mul_s8(void)
{
    ...
    muriscv_nn_status result = muriscv_nn_elementwise_mul_s8(input_data1,
                                                             input_data2,
                                                             input_1_offset,
                                                             input_2_offset,
                                                             output,
...
int main(void)
{
    ...
    RUN_TEST(mul_muriscv_nn_elementwise_mul_s8);
