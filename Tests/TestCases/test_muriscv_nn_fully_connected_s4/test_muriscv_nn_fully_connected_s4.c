...
void fully_connected_int4_muriscv_nn_fully_connected_s4(void)
{
    ...
    muriscv_nn_status result = muriscv_nn_fully_connected_s4(&ctx,
                                                        &fc_params,
                                                        &quant_params,
                                                        &input_dims,
                                                        input_data,
...
void fully_connected_int4_muriscv_nn_fully_connected_s4_2(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void fully_connected_int4_muriscv_nn_fully_connected_s4_3(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void fully_connected_int4_muriscv_nn_fully_connected_s4_4(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void fully_connected_int4_muriscv_nn_fully_connected_s4_5(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void fully_connected_int4_muriscv_nn_fully_connected_s4_6(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
