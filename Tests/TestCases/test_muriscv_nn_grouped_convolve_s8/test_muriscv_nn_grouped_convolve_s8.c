...
void grouped_conv_muriscv_nn_grouped_convolve_1_s8(void)
{
...
void grouped_conv_muriscv_nn_grouped_convolve_2_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void grouped_conv_muriscv_nn_grouped_convolve_3_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void grouped_conv_muriscv_nn_grouped_convolve_4_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
