...
void maxpool_int16_1_muriscv_nn_max_pool_s16(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void maxpool_int16_2_muriscv_nn_max_pool_s16(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void maxpool_int16_param_fail_muriscv_nn_max_pool_s16(void)
{
...
int main(void)
{
    ...
    RUN_TEST(maxpool_int16_muriscv_nn_max_pool_s16);
    RUN_TEST(maxpool_int16_1_muriscv_nn_max_pool_s16);
    RUN_TEST(maxpool_int16_2_muriscv_nn_max_pool_s16);
    RUN_TEST(maxpool_int16_param_fail_muriscv_nn_max_pool_s16);
