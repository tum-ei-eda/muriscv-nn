...
#include "../../TestData/test_muriscv_nn_relu6_s8/test_data.h"
...
void test_muriscv_nn_relu6_s8(void)
{
    q7_t *input_data = (q7_t *)relu_input;
    muriscv_nn_status result = muriscv_nn_relu6_s8(input_data, RELU_SIZE);
...
int main(void)
{
    ...
    RUN_TEST(test_muriscv_nn_relu6_s8);
