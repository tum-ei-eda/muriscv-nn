...
#include "../test_muriscv_nn_svdf_s8.c"
#include "unity.h"
...
void test_svdf_int8_muriscv_nn_s8(void) { svdf_int8_muriscv_nn_svdf_s8(); }
void test_svdf_int8_2_muriscv_nn_s8(void) { svdf_int8_2_muriscv_nn_svdf_s8(); }
