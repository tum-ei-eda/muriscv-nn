...
void svdf_muriscv_nn_svdf_state_s16_s8(void)
{
...
void svdf_1_muriscv_nn_svdf_state_s16_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
    muriscv_nn_context input_ctx;
    muriscv_nn_context output_ctx;
    muriscv_nn_svdf_params svdf_1_params;
    muriscv_nn_dims input_dims;
    muriscv_nn_dims weights_feature_dims;
    muriscv_nn_dims weights_time_dims;
    muriscv_nn_dims state_dims;
...
void svdf_2_muriscv_nn_svdf_state_s16_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
    muriscv_nn_context input_ctx;
    muriscv_nn_context output_ctx;
    muriscv_nn_svdf_params svdf_2_params;
    muriscv_nn_dims input_dims;
    muriscv_nn_dims weights_feature_dims;
    muriscv_nn_dims weights_time_dims;
    muriscv_nn_dims state_dims;
...
void svdf_3_muriscv_nn_svdf_state_s16_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
    muriscv_nn_context input_ctx;
    muriscv_nn_context output_ctx;
    muriscv_nn_svdf_params svdf_3_params;
    muriscv_nn_dims input_dims;
    muriscv_nn_dims weights_feature_dims;
    muriscv_nn_dims weights_time_dims;
    muriscv_nn_dims state_dims;
...
int main(void)
{
    ...
    RUN_TEST(svdf_muriscv_nn_svdf_state_s16_s8);
    RUN_TEST(svdf_1_muriscv_nn_svdf_state_s16_s8);
    RUN_TEST(svdf_2_muriscv_nn_svdf_state_s16_s8);
    RUN_TEST(svdf_3_muriscv_nn_svdf_state_s16_s8);
