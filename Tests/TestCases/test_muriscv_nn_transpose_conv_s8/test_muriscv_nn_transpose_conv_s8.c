...
void transpose_conv_1_muriscv_nn_transpose_conv_s8(void)
{
    ...
    muriscv_nn_transpose_conv_params transpose_conv_params;
    ...
    const int32_t buf_size = muriscv_nn_transpose_conv_s8_get_buffer_size(&input_dims, &filter_dims, &output_dims);
    ctx.buf = malloc(buf_size);
    ctx.size = buf_size;

    muriscv_nn_status result = muriscv_nn_transpose_conv_s8(&ctx,
                                                       &output_ctx,
...
void transpose_conv_2_muriscv_nn_transpose_conv_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void transpose_conv_3_muriscv_nn_transpose_conv_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
...
void transpose_conv_4_muriscv_nn_transpose_conv_s8(void)
{
    const muriscv_nn_status expected = MURISCV_NN_SUCCESS;
