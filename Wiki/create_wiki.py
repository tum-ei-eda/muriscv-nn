...
content = template.render(aww_tflmi_data=aww_tflmi_csv, vww_tflmi_data=vww_tflmi_csv, resnet_tflmi_data=resnet_tflmi_csv, toycar_tflmi_data=toycar_tflmi_csv, aww_tvmaot_data=aww_tvmaot_csv, vww_tvmaot_data=vww_tvmaot_csv, resnet_tvmaot_data=resnet_tvmaot_csv, toycar_tvmaot_data=toycar_tvmaot_csv)
